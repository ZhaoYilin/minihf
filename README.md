...
minihf/ ├── basis/ # Basis set handling ├── hamiltonian/ # Hamiltonian construction │ └── integral/ # Integral calculations ├── molecule/ # Molecule definition └── scf/ # SCF solvers ├── rhf.py # Restricted HF ├── uhf.py # Unrestricted HF ├── rohf.py # Restricted Open-shell HF └── ghf.py # Generalized HF